...
@section('content')
    <div class="container m-auto text-center pt-15 pb-4 mt-2">
        <h1 class="text-xl md:text-2xl sm:text-2xl font-bold text-gray-700">Search Results for "{{ $query }}"</h1>
    </div>

    @if (Auth::check())
        <div class="flex justify-center">
            <a class="btn btn-sm bg-green-200 text-green-600 hover:bg-green-300 mt-2 uppercase" href="/blog/create">Add new
                post</a>
        </div>
    @endif
